...
Java_com_example_sockets_1android_1pdytr2021_Server_runServer(JNIEnv *env, jobject thiz,
    ...
    // Prepara la ip recibida como argumento
    const char *ip = (*env)->GetStringUTFChars(env, ipAddr, NULL);
    ...
    int res = strcmp(ip,"Todas las interfaces\0");
